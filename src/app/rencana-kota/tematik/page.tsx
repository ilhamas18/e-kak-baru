...
import DataTematikKota from '@/components/pages/rencana-kota/tematik/list';
...
const TematikKota = () => {
  ...
  const fetchDataTematik = () => {
    let temp: any = [
      {
        id: 1,
        tema: 'Peningkatan Kemandirian Ekonomi yang Inklusif',
        indikator: [
          {
            text: 'Indeks Pembangunan Ekonomi Inklusif',
            target: '6.44',
            satuan: 'Indeks',
            keterangan: '-'
          }
  ...
  return (
    <div className='tematik-kota-container'>
      ...
      <div className='body relative'>
        ...
        <DataTematikKota data={dataTematik} />
      </div>
    </div>
  )
}

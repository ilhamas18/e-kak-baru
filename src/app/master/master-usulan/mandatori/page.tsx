...
import DataMandatori from '@/components/pages/master/master-usulan/mandatori/list';
...
const Mandatori = () => {
  ...
  const fetchDataMandatori = () => {
    let temp: any = [
      {
        id: 1,
        tahun: 2023,
        usulan: 'Bahwa dalam mendukung kinerja, perlu adanya dukungan sarana dan prasarana kantor yang memadai',
        peraturan: 'Peraturan Daerah Nomor 15 Tahun 2011 tentang Pelayanan Publik sebagaimana telah diubah dengan Peraturan Daerah Nomor 5 Tahun 2019',
        uraian: 'Bahwa dalam mendukung kinerja, perlu adanya dukungan sarana dan prasarana kantor yang memadai',
      ...
      },
      {
        id: 1,
        tahun: 2023,
        usulan: 'Pemenuhan kebutuhan perjalanan dinas dalam rangka koordinasi dan konsultasi ke luar daerah',
        peraturan: 'Peraturan Walikota Madiun Nomor 83 Tahun 2021 tentang Kedudukan, Susunan Organisasi, Rincian Tugas dan Fungsi, serta Tata Kerja Badan Perencanaan, Penelitian dan Pengembangan Daerah',
        uraian: 'Bahwa untuk melaksanakan tupoksi dengan baik, maka perlu dukungan pemenuhan koordinasi dan konsultasi (perjalanan dinas)',
        pengusul: 'PURWANTO',
        opd: 'Badan Perencanaan, Penelitian dan Pengembangan Daerah',
        status: 'Waiting'
      }
    ]
    setDataMandatori(temp);
  }
  ...
  return (
    <div className='mandatori-container'>
      ...
      <div className='body relative'>
        ...
        <DataMandatori data={dataMandatori} />
      </div>
    </div>
  )
}

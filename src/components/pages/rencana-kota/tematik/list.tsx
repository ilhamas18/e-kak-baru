...
const DataTematikKota = ({ data }: PropTypes) => {
                  ...
                  return (
                    <React.Fragment>
                      <TableRow hover role="checkbox" tabIndex={-1} key={index}>
                        ...
                        <TableCell align='center' rowSpan={row.indikator.length + 1}>{row.tema}</TableCell>
                      </TableRow>
                      {row.indikator.map((el: any, i: number) => (
                        <TableRow hover role="checkbox" key={i}>
                          ...
                          <TableCell align='center'>{el.keterangan}</TableCell>
                        </TableRow>
                      ))}
                    </React.Fragment>
                  );

...
const SubTematikProps = ({ subTematik, showAll, trigger, key }: PropTypes) => {
    ...
    <li>
      <div className='tree-child bg-white w-[30em] flex flex-col gap-4 border' key={key}>
        <div className={`${!openEdit ? 'show' : 'hidden'}`}>
          ...
          <table className='flex flex-col border text-black bg-white mt-4'>
            <tbody>
          ...
          <div className='flex flex-col space-y-3 w-full'>
            ...
            {!showTactical ? (
              <button className='px-4 py-1 rounded rounded-md border w-full hover:bg-xl-base duration-500' onClick={() => setShowTactical(true)}>
                Show
              </button>
            ) : (
              <div className='flex gap-2'>
                <button className='px-4 py-1 rounded rounded-md border w-full hover:bg-xl-base duration-500' onClick={() => setShowTactical(false)}>
                  Hidden
                </button>
                <button

          ...
          <Table stickyHeader aria-label="sticky table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="center" style={{ minWidth: 220 }}>SUB TEMATIK</TableCell>
                  ...
                  return (
                    <React.Fragment>
                      <TableRow hover role="checkbox" tabIndex={-1} key={index}>
                        <TableCell align='center' rowSpan={row.sub_tematik.length + 1}>{index + 1}</TableCell>
                        <TableCell align='center' rowSpan={row.sub_tematik.length + 1}>
                        ...
                        <TableCell align='center' rowSpan={row.sub_tematik.length + 1}>{row.tematik}</TableCell>
                      </TableRow>
                      {row.sub_tematik.map((el: any, i: number) => (
                        // <>
                        <TableRow hover role="checkbox" key={i}>
                          <TableCell align='center' rowSpan={el.indikator.length + 1}>{el.sub_tematik}</TableCell>
                          <TableCell align='center' rowSpan={el.indikator.length + 1}>{el.keterangan}</TableCell>
                          {el.indikator.map((el2: any, i2: number) => (
                            <TableRow>
                              <TableCell align='center'>{el2.indikator}</TableCell>
                              <TableCell align='center'>{el2.target}</TableCell>
                            </TableRow>
                          ))}
                        </TableRow>
                        // </>
